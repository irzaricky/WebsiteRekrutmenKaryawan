...
class ValidNIK implements Rule
{
    ...
    public function passes($attribute, $value)
    {
        ...
        $kota = str_pad(substr($value, 2, 2), 2, '0', STR_PAD_LEFT);
        $kecamatan = str_pad(substr($value, 4, 2), 2, '0', STR_PAD_LEFT);
