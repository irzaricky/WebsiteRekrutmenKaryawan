                ...
                <form class="create-form" id="create-form" action="{{ route('hr/employee/save') }}" method="POST"
                    ...
                    <div class="grid grid-cols-1 gap-4 xl:grid-cols-12">
                        ...
                        <div class="xl:col-span-12">
                            ...
                            <input type="text" name="email" id="emailInput"
                                ...
                                placeholder="example@starcode.com" value="{{ old('email') }}">
                            @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="flex justify-end gap-2 mt-4">
                        ...
                        <button type="submit" id="addNew"
                            class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20 addEmployeeModal">Add
                            Employee</button>
                    </div>
                </form>
            </div>
                ...
                <form class="create-form" id="create-form" action="{{ route('hr/employee/update') }}" method="POST"
                    ...
                    <div class="grid grid-cols-1 gap-4 xl:grid-cols-12">
                        <div class="xl:col-span-12">
                            <div
                                class="relative mx-auto mb-4 rounded-full shadow-md size-24 bg-slate-100 profile-user dark:bg-zink-500">
                                <img id="e_photo_edit" src="{{ URL::to('assets/images/user.png') }}" alt=""
