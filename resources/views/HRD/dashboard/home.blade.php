            ...
            <div class="grid grid-cols-12 2xl:grid-cols-12 gap-x-5">
                <div class="col-span-12 md:order-1 xl:col-span-8 2xl:col-span-6">
                    ...
                    <p class="mb-5 text-slate-500 dark:text-zink-200">The salary of<a href="#!"
                            class="underline text-slate-800 dark:text-zink-50"> StarCode Kh</a> is pending since 05 Dec,
                        2024. the documentation of the tasks, workflows, and activities that make up a process managed by
                        the HR or People Ops team. <a href="#!" class="text-red-500">Learn More</a></p>
                </div>
                                        ...
                                        <td
                                            ...
                                            <div class="flex gap-2">
                                                <div
                                                    ...
                                                    <img src="{{ URL::to('assets/images/avatar-10.png') }}" alt=""
                    ...
                    <div class="card-body">
                        ...
                        <div class="flex gap-3 p-2 mt-3 rounded-md bg-custom-500">
                            ...
                            <div>
                                ...
                                <p class="text-custom-200">If you would like to learn more about transferring the license
                                    to a customer</p>
                            </div>
                        </div>
                    </div>
